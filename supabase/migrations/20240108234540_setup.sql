...
AS $$
DECLARE
  project_url TEXT := 'http://ai-supaapi.biz-architect.com';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.ewogICJyb2xlIjogInNlcnZpY2Vfcm9sZSIsCiAgImlzcyI6ICJzdXBhYmFzZSIsCiAgImlhdCI6IDE3MTAwNDY4MDAsCiAgImV4cCI6IDE4Njc4MTMyMDAKfQ.VFBR0zLBOflRUo-Fx9sd8rcl1098o3pFnRjf396T59M'; -- full access needed for http request to storage
